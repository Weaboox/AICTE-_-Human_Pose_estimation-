...
DEMO_IMAGE = 'F:\edunet internship\human pose estimation using  machine learning\yoga-poses-for-beginners-alt-1440x810.jpg'
...
st.image(
        output , caption=f"Postions Estimated"  , use_column_width=True  
)
